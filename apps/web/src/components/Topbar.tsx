    ...
    <header className="bg-surface/80 backdrop-blur-md fixed top-0 right-0 w-full md:w-[calc(100%-260px)] h-16 z-40 border-b border-outline-variant/20 shadow-sm flex justify-between items-center px-4 md:px-6">
      ...
      <div className="flex items-center gap-4 text-on-surface-variant">
        <button
          ...
          className="hover:text-primary transition-colors cursor-pointer p-2 rounded-full hover:bg-surface-variant/50"
        >
        ...
        <button
          ...
          onClick={() => toast.info(t("common.no_notifications"))}
          className="hover:text-primary transition-colors cursor-pointer p-2 rounded-full hover:bg-surface-variant/50 relative"
        >
          <span
