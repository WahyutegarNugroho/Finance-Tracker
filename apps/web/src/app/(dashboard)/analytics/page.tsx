  ...
  return (
    <div className="flex flex-col gap-6 md:gap-8 animate-in fade-in slide-in-from-bottom-4 duration-700">
      ...
      <section className="bg-surface border border-outline-variant/20 shadow-sm rounded-xl p-6 md:p-8 flex flex-col gap-6">
        ...
        <div
          className="w-full h-[320px] relative mt-4"
          role="region"
          aria-label={t("analytics_page.charts.income_vs_expense")}
        >
        ...
        <div className="bg-surface border border-outline-variant/20 shadow-sm rounded-xl p-6 flex flex-col gap-6">
          ...
          <div className="flex flex-col sm:flex-row items-center gap-8 justify-center py-4">
            <div
              ...
              role="region"
              aria-label={t("analytics_page.charts.spending_by_category")}
            >
              {Array.isArray(categories) && categories.length > 0 ? (
                <>
                  ...
                  <div className="absolute w-28 h-28 flex flex-col items-center justify-center pointer-events-none">
                    ...
                    <span className="font-numeric-data text-lg font-bold text-on-surface">
                      {formatCurrency(breakdown?.totalExpense || 0)}
                    </span>
                  </div>
                </>
              ) : (
                    ...
                    <div key={cat.categoryId} className="flex items-center justify-between gap-4">
                      <div className="flex items-center gap-2">
                        <div
                          ...
                          style={{ backgroundColor: getCategoryColor(cat.categoryName, idx) }}
                        ></div>
                        <span className="text-sm text-on-surface-variant font-medium truncate max-w-[120px]">
                          {tCategory(cat.categoryName)}
                        </span>
                      </div>
                  ...
                  return (
                    ...
                    >
                      ...
                      <div className="flex-1">
                        ...
                        <div className="text-[10px] text-outline uppercase tracking-wider font-bold">
                          {t("analytics_page.top_category")}
                        </div>
                      </div>
                      <div className="flex flex-col items-end">
                        <span className="font-numeric-data font-bold text-on-surface">
